...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*RealTimeArgs)(nil), (*config.RealTimeArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta3_RealTimeArgs_To_config_RealTimeArgs(a.(*RealTimeArgs), b.(*config.RealTimeArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.RealTimeArgs)(nil), (*RealTimeArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_RealTimeArgs_To_v1beta3_RealTimeArgs(a.(*config.RealTimeArgs), b.(*RealTimeArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta3_RealTimeArgs_To_config_RealTimeArgs(in *RealTimeArgs, out *config.RealTimeArgs, s conversion.Scope) error {
	return nil
}

// Convert_v1beta3_RealTimeArgs_To_config_RealTimeArgs is an autogenerated conversion function.
func Convert_v1beta3_RealTimeArgs_To_config_RealTimeArgs(in *RealTimeArgs, out *config.RealTimeArgs, s conversion.Scope) error {
	return autoConvert_v1beta3_RealTimeArgs_To_config_RealTimeArgs(in, out, s)
}

func autoConvert_config_RealTimeArgs_To_v1beta3_RealTimeArgs(in *config.RealTimeArgs, out *RealTimeArgs, s conversion.Scope) error {
	return nil
}

// Convert_config_RealTimeArgs_To_v1beta3_RealTimeArgs is an autogenerated conversion function.
func Convert_config_RealTimeArgs_To_v1beta3_RealTimeArgs(in *config.RealTimeArgs, out *RealTimeArgs, s conversion.Scope) error {
	return autoConvert_config_RealTimeArgs_To_v1beta3_RealTimeArgs(in, out, s)
}
